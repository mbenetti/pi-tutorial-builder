...
flowchart TD
    ...
    LLMH1 --> OutputH1[Top 5-10 concepts extracted with Analogies]:::stepClass
    ...
    LLMH2 --> OutputH2[Project summary & relationship Mermaid nodes]:::stepClass
    ...
    LLMH3 --> OutputH3[Optimal pedagogical sequence mapped]:::stepClass
    ...
    LLMH4 --> OutputH4[Slices assembled & surrounds stripped]:::stepClass
